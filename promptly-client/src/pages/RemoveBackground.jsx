    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700 dark:text-slate-200">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <UsageCounter feature="remove-bg" accentColor="#ff4938" />
        </div>
        ...
        <input
          ...
          type="file"
          accept="image/*"
          className="w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300 dark:border-slate-600 dark:bg-slate-700 text-gray-600 dark:text-gray-400"
          required
        />
