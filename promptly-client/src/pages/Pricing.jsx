...
const plans = [
  {
    ...
    features: [
      "5 articles per day",
      "5 blog title generations per day",
      "5 AI image generations per day",
      "2 background removals per day",
      "2 object removals per day",
      "Improve My Prompt (AI)",
      "Dashboard & creation history",
  ...
  },
  {
    ...
    price: "₹399",
    period: "/month",
    description: "Unlimited access to every AI feature, no daily limits.",
    features: [
