  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        ...
        { description: input, style: selectedStyle, publish, improvePromptFlag },
        {
      ...
      >
        ...
        <div className="my-6 flex items-center gap-2">
          <label className="relative cursor-pointer">
            ...
            <div className="w-9 h-5 bg-slate-300 dark:bg-slate-600 rounded-full peer-checked:bg-green-500 transition"></div>
        ...
        <div className="mb-4 flex items-center gap-2">
          <label className="relative cursor-pointer">
            ...
            <div className="w-9 h-5 bg-slate-300 dark:bg-slate-600 rounded-full peer-checked:bg-[#00ad25] transition"></div>
            <span className="absolute left-1 top-1 w-3 h-3 bg-white rounded-full transition peer-checked:translate-x-4"></span>
          </label>
